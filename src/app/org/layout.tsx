                ...
                <div className="space-y-0.5">
                  {group.items.map((item) => (
                    <Link
                      ...
                      `}
                    >
                      <span className={`transition-colors ${isActive(item.href) ? "text-blue-400" : "text-slate-500 group-hover/nav:text-slate-500 dark:text-slate-400"}`}>
                        {item.icon}
                      </span>
          ...
          <div className="border-t border-[var(--border)] px-3 py-3 space-y-1">
            ...
            <div className="flex items-center gap-2.5 px-3 py-1.5">
              ...
              <div className="flex-1 min-w-0">
                ...
                <div className="text-[10px] text-slate-500 dark:text-slate-600 truncate">Admin</div>
              </div>
