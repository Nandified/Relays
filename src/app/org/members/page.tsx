                ...
                <tr key={member.id} className="hover:bg-black/[0.02] dark:hover:bg-white/[0.02] transition-colors group">
                  ...
                  <td className="px-4 py-3 hidden sm:table-cell">
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs text-slate-600 dark:text-slate-400 capitalize">{member.status}</span>
                    </div>
                  </td>
                  ...
                  <td className="px-4 py-3 text-right">
                    <div className="flex items-center justify-end gap-1 opacity-0 group-hover:opacity-100 transition-opacity">
                      <button
                        ...
                        className="rounded-lg px-2 py-1 text-xs text-slate-600 dark:text-slate-400 hover:bg-black/5 dark:hover:bg-white/5 hover:text-slate-800 dark:hover:text-slate-200 transition-colors"
                        title="Change Role"
                      >
                        Role
                      </button>
