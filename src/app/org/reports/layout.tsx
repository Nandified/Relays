      ...
      <div className="border-b border-[var(--border)] bg-[var(--bg-subtle)]">
        <div className="mx-auto max-w-6xl px-4">
          <div className="flex items-center gap-1 py-2">
            <span className="text-xs text-slate-500 dark:text-slate-400 mr-2 font-medium uppercase tracking-wider">Brokerage Reports</span>
                ...
                <Link
                  ...
                  className={`
                    ...
                    ${active
                      ...
                      : "text-slate-600 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 hover:bg-black/5 dark:hover:bg-white/5"
                    }
                  `}
                >
                  <span>{link.icon}</span>
