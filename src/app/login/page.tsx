      ...
      <Card padding="lg" className="shadow-[var(--shadow-elevated)]">
        {sent ? (
          <div className="text-center py-4">
            ...
            {!isSupabase && (
              <p className="mt-3 text-xs text-slate-500 dark:text-slate-400">(Demo: auto-signing you in...)</p>
            )}
          </div>
        ) : (
            ...
            {mode === "magic" ? (
              <>
                ...
                <button
                  ...
                  className="w-full text-center text-xs text-slate-600 dark:text-slate-400 hover:text-slate-700 dark:hover:text-slate-300 transition-colors"
                >
