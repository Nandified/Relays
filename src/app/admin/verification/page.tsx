...
export default function VerificationPage() {
  ...
  const todayAutoApproved = autoApproved.filter(v => {
              ...
              <div className="p-4">
                ...
                {ver.ocrData && (
                  <div className="mt-4">
                    ...
                    {isExpanded && (
                      <div className="mt-3 rounded-xl border border-[var(--border)] bg-white/[0.02] p-4 space-y-3 animate-in">
                        {/* Confidence Score */}
                        <div>
                          <div className="text-[11px] font-medium text-slate-500 uppercase tracking-wide mb-1.5">Confidence Score</div>
                          ...
                          <div>
                            ...
                            <div className="mt-0.5 flex items-center gap-1.5">
                              ...
                              {ver.ocrData.nameMatch ? (
                                <svg width="14" height="14" fill="none" stroke="#10b981" strokeWidth="2" viewBox="0 0 24 24"><path d="M20 6L9 17l-5-5" /></svg>
                              ) : (
                                <svg width="14" height="14" fill="none" stroke="#ef4444" strokeWidth="2" viewBox="0 0 24 24"><path d="M18 6L6 18M6 6l12 12" /></svg>
                              )}
                            </div>
                          </div>
                          <div>
                        ...
                        <div className="rounded-xl border border-dashed border-[var(--border)] bg-white/[0.01] p-6 text-center">
                          <svg width="32" height="32" fill="none" stroke="currentColor" strokeWidth="1" viewBox="0 0 24 24" className="mx-auto text-slate-600 mb-2">
                            <path d="M7 21h10a2 2 0 002-2V9.414a1 1 0 00-.293-.707l-5.414-5.414A1 1 0 0012.586 3H7a2 2 0 00-2 2v14a2 2 0 002 2z" />
                          </svg>
                          <p className="text-xs text-slate-500">
                            {ver.documentType === "pdf" ? "PDF Document" : "Image Document"} uploaded
                          </p>
                          <button className="mt-2 text-xs text-violet-400 hover:underline">View document →</button>
                        </div>
                      </div>
                    )}
                  </div>
