      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <Card padding="lg" className="glow-violet">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold text-slate-200">Signup Trend</h3>
        ...
        <Card padding="lg" className="glow-violet">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold text-slate-200">Pro Distribution</h3>
        ...
        <Card padding="lg" className="glow-violet">
          <div className="mb-4 flex items-center justify-between">
            <div>
              <h3 className="text-sm font-semibold text-slate-200">Requests by Status</h3>
            ...
            <div className="space-y-2">
              ...
              <Link href="/admin/data-import">
                <Card hover padding="sm" className="flex items-center gap-3 glow-violet">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-slate-200">Data Import</div>
              ...
              <Link href="/admin/metrics">
                <Card hover padding="sm" className="flex items-center gap-3 glow-violet">
                  ...
                  <div className="flex-1">
                    <div className="text-sm font-medium text-slate-200">Detailed Analytics</div>
