      ...
      <main>
        ...
        <section className="border-y border-[var(--border)] bg-[var(--bg-subtle)]">
          <div className="mx-auto max-w-6xl px-4 py-16 md:py-24">
            <AnimatedSection>
              <h2 className="text-2xl font-bold text-slate-100 text-center mb-12">Built for Everyone in the Transaction</h2>
            </AnimatedSection>
              ...
              {valueProps.map((vp, i) => (
                <AnimatedSection key={vp.audience} delay={i * 120}>
                  <div className={`rounded-3xl border bg-gradient-to-b ${vp.accent} p-6 h-full`}>
                    ...
                    <h3 className="text-lg font-semibold text-slate-100 mt-3 mb-4">{vp.audience}</h3>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 md:py-24">
          <AnimatedSection>
            <h2 className="text-2xl font-bold text-slate-100 text-center mb-3">Meet the Team</h2>
        ...
        <section className="border-t border-[var(--border)] bg-[var(--bg-subtle)]">
          <div className="mx-auto max-w-6xl px-4 py-16 md:py-20">
            <AnimatedSection>
              <h2 className="text-lg font-semibold text-slate-300 text-center mb-8">In the Press</h2>
              <div className="flex flex-wrap items-center justify-center gap-8">
                {["TechCrunch", "Inman News", "HousingWire", "RealTrends"].map((pub) => (
                  <span key={pub} className="text-lg font-semibold text-slate-600/60">{pub}</span>
                ))}
              </div>
              <p className="text-xs text-slate-600 text-center mt-4">Coming soon</p>
            </AnimatedSection>
          </div>
        </section>
            ...
            <div className="relative rounded-3xl overflow-hidden p-8 md:p-12 text-center">
              ...
              <div className="relative">
                ...
                <div className="mt-6 flex flex-col items-center gap-3 sm:flex-row sm:justify-center">
                  ...
                  <Link href="/help" className="hover-scale inline-flex items-center justify-center rounded-2xl border border-white/20 px-6 py-3 text-base font-medium text-white hover:bg-white/10 transition-all">
                    Help Center
                  </Link>
                </div>
              </div>
