        ...
        <Card padding="lg" className="animate-in">
          ...
          <div className="space-y-6">
            <div>
              ...
              />
              <p className="text-xs text-slate-600 dark:text-slate-400 mt-1">Separate with commas. Currently serving: {serviceArea || "Not set"}</p>
            </div>
                ...
                {introVideoUploaded ? (
                  <div className="flex items-center gap-2">
                    ...
                    <div className="text-left">
                      ...
                      <div className="text-xs text-slate-600 dark:text-slate-400">Click to replace</div>
                    </div>
                  </div>
                ) : (
                  <>
                    ...
                    <div className="text-center">
                      ...
                      <div className="text-xs text-slate-600 dark:text-slate-400 mt-0.5">30-60 seconds — let clients see the real you</div>
                    </div>
                  </>
                )}
              </button>
          ...
          <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-elevated)] p-5">
                ...
                {(socialLinks.linkedin || socialLinks.instagram) && (
                  <div className="flex items-center gap-2 mt-2">
                    {socialLinks.linkedin && (
                      <span className="text-[10px] text-slate-600 dark:text-slate-400 bg-black/5 dark:bg-white/5 rounded-md px-2 py-0.5">LinkedIn</span>
                    )}
                    {socialLinks.instagram && (
                      <span className="text-[10px] text-slate-600 dark:text-slate-400 bg-black/5 dark:bg-white/5 rounded-md px-2 py-0.5">Instagram</span>
                    )}
                  </div>
                )}
                {introVideoUploaded && (
            ...
            <div className="mt-4 pt-4 border-t border-[var(--border)] grid grid-cols-3 gap-3 text-center">
              <div>
                ...
                <div className="text-[10px] text-slate-600 dark:text-slate-400">Rating</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-slate-800 dark:text-slate-200">0</div>
                <div className="text-[10px] text-slate-600 dark:text-slate-400">Reviews</div>
              </div>
              <div>
                <div className="text-sm font-semibold text-emerald-400">✓</div>
                <div className="text-[10px] text-slate-600 dark:text-slate-400">Accepting</div>
              </div>
            </div>
          </div>
