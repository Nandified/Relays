        ...
        <div className="relative p-5">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] text-slate-500">{partnerCount} partner{partnerCount !== 1 ? "s" : ""}</span>
            </div>
            ...
            <div className="flex -space-x-1.5">
              ...
              {previewPartners.length > 4 && (
                <div className="flex h-6 w-6 items-center justify-center rounded-full border-2 border-[var(--bg-card)] bg-[var(--bg-elevated)] text-[9px] text-slate-500">
                  +{previewPartners.length - 4}
                </div>
              )}
            </div>
    ...
    <div className="mx-auto max-w-4xl px-4 py-6">
      ...
      <div className="grid grid-cols-3 gap-3 mb-8">
        ...
        <Card padding="md">
          ...
          <div className="text-xs text-slate-500 mt-1">Share Links</div>
        </Card>
      </div>
