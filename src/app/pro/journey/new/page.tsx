  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 pb-20">
      ...
      <div className="mb-8">
        ...
        <p className="mt-1 text-sm text-slate-600 dark:text-slate-400">Set up your client&apos;s home journey with recommended pros for every step.</p>
      </div>
    ...
    <Card padding="lg" className="liquid-glass">
      ...
      <div className="mt-5 rounded-xl bg-blue-500/[0.04] border border-blue-500/10 p-3">
        <div className="flex items-start gap-2">
          ...
          <p className="text-[11px] text-slate-600 dark:text-slate-400">Your client will receive a link to view their journey and select pros from your recommendations.</p>
        </div>
      </div>
    </Card>
  );
