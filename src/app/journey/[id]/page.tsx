  ...
  return (
    <div className="relative" style={{ width: size, height: size }}>
      ...
      <div className="absolute inset-0 flex flex-col items-center justify-center">
        ...
        <span className="text-[10px] text-slate-600 dark:text-slate-400">filled</span>
      </div>
    </div>
  );
}
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="flex items-center gap-2 mt-1">
            ...
            <span className="text-[11px] text-slate-500 dark:text-slate-400">{pro.reviewCount} reviews</span>
          </div>
        </div>
  ...
  return (
    <div className="glass-card rounded-2xl p-4 hover-lift cursor-pointer group">
      <div className="flex flex-col items-center text-center">
        ...
        <p className="text-[11px] text-slate-600 dark:text-slate-400 mt-0.5">{pro.companyName}</p>
        <div className="flex items-center gap-1 mt-2">
          ...
          <span className="text-[11px] text-slate-600 dark:text-slate-400 tabular-nums">({pro.reviewCount})</span>
        </div>
    ...
    >
      <div className="flex items-center justify-between mb-4">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-[11px] text-slate-600 dark:text-slate-400">{meta.description}</p>
          </div>
        </div>
        <div>
          {role.status === "filled" && (
        ...
        <div>
          ...
          <div className="mt-3 text-center">
            <Link
              ...
              className="inline-flex items-center gap-1 text-xs text-slate-600 dark:text-slate-400 hover:text-blue-500 dark:text-blue-400 transition-colors"
            >
      ...
      {role.status === "needed" && (
        <div className="flex flex-col items-center py-6">
          ...
          <p className="text-xs text-slate-500 dark:text-slate-400 mb-3">Your pro will recommend someone, or find your own</p>
...
export default function JourneyPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    return (
      <div className="flex min-h-[60vh] items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-sm text-slate-600 dark:text-slate-400">This link may be expired or invalid.</p>
          <Link href="/dashboard">
  ...
  return (
    <div className="mx-auto max-w-3xl px-4 py-6 pb-20">
      ...
      {moments.upcoming.length > 0 && (
        <div className="mb-8">
          <h2 className="text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-3 flex items-center gap-2">
            <svg width="12" height="12" fill="none" stroke="currentColor" strokeWidth="2" viewBox="0 0 24 24" className="text-slate-500 dark:text-slate-400">
      ...
      {/* Role panels */}
      <h2 className="text-sm font-semibold text-slate-600 dark:text-slate-400 uppercase tracking-wider mb-4">Your Team</h2>
