      ...
      <div className="rounded-2xl border border-[var(--border)] bg-[var(--bg-card)]/90 backdrop-blur-sm p-4 transition-all duration-300">
        <div className="flex items-center gap-3">
          ...
          {!uploading && (
            <button
              onClick={clearFile}
              className="flex-shrink-0 rounded-lg p-1.5 text-slate-500 hover:bg-white/5 hover:text-slate-300 transition-colors"
    ...
    <div>
      ...
      >
        ...
        <div className="relative flex flex-col items-center text-center">
            ...
            className={`
              ...
              ${
                isDragOver
                  ...
                  : "border-[var(--border)] bg-white/[0.02] text-slate-500"
              }
            `}
          >
            <svg
          ...
          {/* Label */}
          <p className={`font-medium text-slate-300 ${compact ? "text-xs" : "text-sm"}`}>
