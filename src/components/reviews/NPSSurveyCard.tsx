  ...
  return (
    <div className="rounded-2xl border border-blue-500/15 bg-blue-500/[0.03] p-5">
          ...
          <button
            ...
            className={`h-9 w-9 rounded-lg text-xs font-semibold transition-all duration-200 ${
              selectedScore === score
                ...
                : "bg-black/5 dark:bg-white/5 text-slate-600 dark:text-slate-500 border border-[var(--border)] hover:bg-black/5 dark:hover:bg-white/10 hover:text-slate-700 dark:hover:text-slate-300"
            }`}
          >
            {score}
          </button>
      ...
      <div className="flex justify-between px-1 mb-4">
        <span className="text-[10px] text-slate-500 dark:text-slate-500">Not likely</span>
        <span className="text-[10px] text-slate-500 dark:text-slate-500">Very likely</span>
      </div>
