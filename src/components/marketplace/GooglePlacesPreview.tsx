    ...
    <Card padding="lg" glow className="border-dashed">
      ...
      <div className="flex items-center gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <div className="truncate text-sm text-slate-600 dark:text-slate-400">{place.address}</div>
        </div>
      </div>
      ...
      <div className="mt-3 flex items-center gap-2">
        ...
        <span className="text-xs text-slate-600 dark:text-slate-400">({place.reviewCount} reviews)</span>
      </div>
