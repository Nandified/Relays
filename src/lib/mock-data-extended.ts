...
export const mockPricingTiers: PricingTier[] = [
  {
    id: "free",
    name: "Free",
    description: "Get discovered and start receiving referrals",
    monthlyPrice: 0,
    annualPrice: 0,
    features: [
      { text: "Marketplace presence", included: true },
      { text: "Basic profile & badge", included: true },
      { text: "Request-to-connect leads", included: true },
      { text: "Claim your Google listing", included: true },
      { text: "Journey management", included: false },
      { text: "Curated groups", included: false },
  ...
  },
  {
    id: "pro",
    name: "Pro",
    description: "Full journey management for solo agents",
    monthlyPrice: 49,
    annualPrice: 39,
    features: [
      { text: "Everything in Free", included: true },
      { text: "Full journey management", included: true, highlight: true },
      { text: "3 curated share links", included: true },
      { text: "Calendar integration", included: true },
      { text: "Analytics & insights", included: true },
      { text: "Document workflow", included: true },
  ...
  },
  {
    id: "team",
    name: "Team",
    description: "For teams of up to 10 agents",
    monthlyPrice: 149,
    annualPrice: 119,
    features: [
      { text: "Everything in Pro", included: true },
      { text: "Up to 10 seats", included: true, highlight: true },
      { text: "Team dashboard & oversight", included: true },
      { text: "30 curated share links", included: true },
      { text: "Shared groups across team", included: true },
      { text: "Transaction coordinator tools", included: true },
      { text: "Team analytics", included: true },
      { text: "RBAC & compliance", included: false },
    ],
    cta: "Start Free Trial",
    ctaVariant: "primary",
  },
  {
    id: "brokerage",
    name: "Brokerage",
    description: "Enterprise-grade for offices & brokerages",
    monthlyPrice: 399,
    annualPrice: 319,
    features: [
      { text: "Everything in Team", included: true },
      { text: "Unlimited seats", included: true, highlight: true },
      { text: "RBAC & role management", included: true },
      { text: "Compliance reports & audit logs", included: true },
      { text: "Unlimited share links", included: true },
...
export const mockFAQItems: FAQItem[] = [
  ...
  },
  {
    ...
    answer: "Yes! Pro and Team plans come with a 14-day free trial. No credit card required to start. You can explore all features and decide if Relays is right for your business.",
    category: "billing",
  },
  {
    id: "faq_14",
